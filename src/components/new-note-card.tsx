  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className='fixed inset-0 md:inset-auto overflow-hidden md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:max-w-[640px] md:h-[60vh] 
        w-full bg-slate-700 md:rounded-md flex flex-col outline-none'>
          ...
          <form className='flex-1 flex flex-col'>
            <div className='flex flex-1 flex-col gap-3 p-5'>
              ...
              {shouldShowOnboarding ? (
                ...
                <textarea onChange={handleContentChanged} value={content} autoFocus className='text-sm leading-6 text-slate-400 bg-transparent resize-none flex-1 outline-none' />
              )}
            </div>
